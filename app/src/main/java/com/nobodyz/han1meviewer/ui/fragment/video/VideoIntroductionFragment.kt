package com.nobodyz.han1meviewer.ui.fragment.video
...
import com.nobodyz.han1meviewer.ADVANCED_SEARCH_MAP
import com.nobodyz.han1meviewer.HAdvancedSearch
import com.nobodyz.han1meviewer.HCacheManager
...
import com.nobodyz.han1meviewer.VIDEO_LAYOUT_MATCH_PARENT
import com.nobodyz.han1meviewer.VIDEO_LAYOUT_WRAP_CONTENT
import com.nobodyz.han1meviewer.VideoCoverSize
import com.nobodyz.han1meviewer.databinding.FragmentVideoIntroductionBinding
import com.nobodyz.han1meviewer.databinding.ItemVideoIntroductionBinding
import com.nobodyz.han1meviewer.getHanimeShareText
import com.nobodyz.han1meviewer.getHanimeVideoDownloadLink
import com.nobodyz.han1meviewer.getHanimeVideoLink
import com.nobodyz.han1meviewer.logic.model.HanimeInfo
import com.nobodyz.han1meviewer.logic.model.HanimeVideo
import com.nobodyz.han1meviewer.logic.model.SearchOption
...
import com.nobodyz.han1meviewer.ui.adapter.AdapterLikeDataBindingPage
import com.nobodyz.han1meviewer.ui.adapter.BaseSingleDifferAdapter
import com.nobodyz.han1meviewer.ui.adapter.HanimeVideoRvAdapter
import com.nobodyz.han1meviewer.ui.adapter.RvWrapper.Companion.wrappedWith
import com.nobodyz.han1meviewer.ui.adapter.VideoColumnTitleAdapter
import com.nobodyz.han1meviewer.ui.fragment.PermissionRequester
import com.nobodyz.han1meviewer.ui.fragment.PlaylistBottomSheetFragment
import com.nobodyz.han1meviewer.ui.viewmodel.VideoViewModel
import com.nobodyz.han1meviewer.util.loadAssetAs
import com.nobodyz.han1meviewer.util.openVideo
import com.nobodyz.han1meviewer.util.requestPostNotificationPermission
import com.nobodyz.han1meviewer.util.setDrawableTop
import com.nobodyz.han1meviewer.util.showAlertDialog
import com.nobodyz.han1meviewer.worker.HanimeDownloadManagerV2
import com.nobodyz.han1meviewer.worker.HanimeDownloadWorker
