package com.nobodyz.han1meviewer.ui.widget
...
import com.nobodyz.han1meviewer.logic.dao.CheckInRecordDatabase
import com.nobodyz.han1meviewer.logic.entity.CheckInRecordEntity
...
class CheckInWidgetProvider : AppWidgetProvider() {
    ...
    companion object {
        const val ACTION_CHECK_IN = "com.nobodyz.han1meviewer.ACTION_WIDGET_CHECK_IN"
    }
